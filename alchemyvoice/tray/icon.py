...
class NeoTrayIcon(QSystemTrayIcon):
    ...
    def _process_events(self) -> None:
        ...
        from alchemyvoice.tray.events import TrayEvent
    ...
    def _handle_approval(self, msg) -> None:
        ...
        from alchemyvoice.tray.dialogs import ApprovalDialog
    ...
    def _open_viewport(self) -> None:
        ...
        if self._viewport_window is None:
            from alchemyvoice.tray.viewport import ViewportWindow
